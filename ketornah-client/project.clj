(defproject ketornah-client "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "ketornah-client.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main ketornah-client.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "ketornah-client.core/on-figwheel-reload"}
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "ketornah-client.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
