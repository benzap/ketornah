...
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs42502))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["search-result-metric","search-result-carbs"], null)], null),attrs42502)):({"className": "search-result-metric search-result-carbs"})),((cljs.core.map_QMARK_.call(null,attrs42502))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs42502)], null)));
...
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs42503))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["search-result-metric","search-result-protein"], null)], null),attrs42503)):({"className": "search-result-metric search-result-protein"})),((cljs.core.map_QMARK_.call(null,attrs42503))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs42503)], null)));
...
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs42504))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["search-result-metric","search-result-fat"], null)], null),attrs42504)):({"className": "search-result-metric search-result-fat"})),((cljs.core.map_QMARK_.call(null,attrs42504))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs42504)], null)));
...
return ketornah_client.utils.remove_tooltips_from_body.call(null);
} else {
return null;
}
});})(map__42505,map__42505__$1,search_text,search_items,querying_QMARK_))
, "onClick": ((function (map__42505,map__42505__$1,search_text,search_items,querying_QMARK_){
return (function (e){
var target = e.target;
return target.setSelectionRange((0),target.value.length);
});})(map__42505,map__42505__$1,search_text,search_items,querying_QMARK_))
}))),(function (){var attrs42507 = (cljs.core.truth_(querying_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,".search-querying.animated.pulse",".search-querying.animated.pulse",417438425),"Querying..."], null):((!(cljs.core.empty_QMARK_.call(null,search_items)))?(function (){var iter__36038__auto__ = ((function (map__42505,map__42505__$1,search_text,search_items,querying_QMARK_){
