...
var x__35918__auto__ = (((x == null))?null:x);
var m__35919__auto__ = (sablono.util.to_str[goog.typeOf(x__35918__auto__)]);
if(!((m__35919__auto__ == null))){
return m__35919__auto__.call(null,x);
} else {
var m__35919__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__35919__auto____$1 == null))){
return m__35919__auto____$1.call(null,x);
} else {
...
var x__35918__auto__ = (((x == null))?null:x);
var m__35919__auto__ = (sablono.util.to_uri[goog.typeOf(x__35918__auto__)]);
if(!((m__35919__auto__ == null))){
return m__35919__auto__.call(null,x);
} else {
var m__35919__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__35919__auto____$1 == null))){
return m__35919__auto____$1.call(null,x);
} else {
...
var len__36363__auto___40947 = arguments.length;
var i__36364__auto___40948 = (0);
while(true){
if((i__36364__auto___40948 < len__36363__auto___40947)){
args__36370__auto__.push((arguments[i__36364__auto___40948]));

var G__40949 = (i__36364__auto___40948 + (1));
i__36364__auto___40948 = G__40949;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__36371__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq40946){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq40946));
});
...
var vec__40953 = cljs.core.name.call(null,k).split("-");
var seq__40954 = cljs.core.seq.call(null,vec__40953);
var first__40955 = cljs.core.first.call(null,seq__40954);
var seq__40954__$1 = cljs.core.next.call(null,seq__40954);
var first_word = first__40955;
var words = seq__40954__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__40961){
var vec__40962 = p__40961;
var k = cljs.core.nth.call(null,vec__40962,(0),null);
var v = cljs.core.nth.call(null,vec__40962,(1),null);
...
return cljs.core.update.call(null,G__40965,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__40965;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__35250__auto__ = x__$1.hasDomain();
